  ...
  if (!registrationEnabled) {
    return (
      <div className="space-y-4">
        <h1 className="text-2xl font-semibold text-foreground">Registration is disabled</h1>
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-2 text-sm text-muted-foreground">Join {organization?.name ?? 'your organization'} to start meeting.</p>
      </div>
      <RegisterForm />
      <p className="text-sm text-muted-foreground">
